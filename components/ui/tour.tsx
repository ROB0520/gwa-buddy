...
interface TourProps
  ...
  /**
   * Automatically start the tour on mount
   * @default false
   */
  autoStart?: boolean;
  /**
...
export const TourBody = (props: React.ComponentProps<"div">) => {
  const { className, ...rest } = props;
  return (
    <div
      data-slot="tour-body"
...
export const TourActions = (
  ...
  return (
    <ArkTour.Control {...rest} asChild>
      <DialogFooter
        className={cn("flex flex-wrap gap-2 sm:rounded-b-none", className)}
